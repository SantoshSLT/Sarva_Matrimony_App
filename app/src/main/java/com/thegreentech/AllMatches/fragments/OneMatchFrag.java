...
public class OneMatchFrag extends Fragment {
    ...
    public static OneMatchFrag newInstance(int sectionNumber)
    {
        OneMatchFrag fragment = new OneMatchFrag();
    ...
    public void init(){
        ...
        rvOneMatch.setLayoutManager(new LinearLayoutManager(context));
    ...
    private void getUserDataRequest(String MatriId, String Gender)
    {
        ...
        class SendPostReqAsyncTask extends AsyncTask<String, Void, String>
        {
            ...
            protected String doInBackground(String... params)
            {
               ...
               // String URL= AppConstants.MAIN_URL +"one_way_match.php";
                String URL= AppConstants.MAIN_URL +"one_way_match.php";
                    ...
                    if (status.equalsIgnoreCase("1"))
                    {
                        ...
                        if (responseData.has("1"))
                        {
                            ...
                            if(arrUserDataList.size() > 0  && arrUserDataList != null)
                            {
                                ...
                                adapterUserData = new UserRecentDataAdapter(context,arrUserDataList, rvOneMatch,tokans);
