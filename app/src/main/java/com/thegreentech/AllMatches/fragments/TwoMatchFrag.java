...
public class TwoMatchFrag extends Fragment {
    ...
    public static TwoMatchFrag newInstance(int sectionNumber)
    {
        TwoMatchFrag fragment = new TwoMatchFrag();
   ...
   /* @Override
    ...
    private void getTwoMatches(String MatriId, String Gender)
    {
        ...
        class SendPostReqAsyncTask extends AsyncTask<String, Void, String>
        {
            ...
            protected String doInBackground(String... params)
            {
                ...
                String URL= AppConstants.MAIN_URL +"two_way_match.php";
                    ...
                    if (status.equalsIgnoreCase("1"))
                    {
                        ...
                        if (responseData.has("1"))
                        {
                            ...
                            if(arrUserDataList.size() > 0  && arrUserDataList != null)
                            {
                                ...
                                adapterUserData = new UserRecentDataAdapter(getActivity(),arrUserDataList, rvOneMatch,tokans);
