...
public class PreferedMatchFrag extends Fragment {
    ...
    public PreferedMatchFrag() {
        // Required empty public constructor
    }


    public static PreferedMatchFrag newInstance(int sectionNumber)
    {
        PreferedMatchFrag fragment = new PreferedMatchFrag();
    ...
    public void init(){
        ...
        if (NetworkConnection.hasConnection(getActivity())){
            getPreferedMatch(matri_id,gender);
        }else
        {
    ...
    private void getPreferedMatch(String MatriId, String Gender)
    {
        ...
        class SendPostReqAsyncTask extends AsyncTask<String, Void, String>
        {
            ...
            protected String doInBackground(String... params)
            {
                ...
                String URL= AppConstants.MAIN_URL +"preferred_match.php";
