...
public class FragmentPhotoRequestSent extends Fragment {
    ...
    public FragmentPhotoRequestSent() {
    }

    public static FragmentPhotoRequestSent newInstance(int sectionNumber) {
        FragmentPhotoRequestSent fragment = new FragmentPhotoRequestSent();
    ...
    private void getPhotoAcceptedRequest(String strMatriId) {
        ...
        String URL = AppConstants.MAIN_URL + "photo_request_sent_all.php";
        client.post(URL, params, new TextHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, String responseString) {
                ...
                Log.e("photo_request_sent_all", "==" + responseString);
                try {
                    ...
                    if (status.equalsIgnoreCase("1")) {
                        ...
                        if (responseData.has("1")) {
                            ...
                            if (arrPhotoPasswordList.size() > 0) {
                                ...
                                adapterPhotoAccepted = new PhotoRequestAdapter(getActivity(), arrPhotoPasswordList, recyclerPhotoAccepted, "PhotoReqSent");
