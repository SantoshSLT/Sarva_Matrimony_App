...
import Adepters.ImportantMessageAdapter;
...
public class FragmentMessagesImportant extends Fragment
{
	...
	private ImportantMessageAdapter adapterMessages;
	private ArrayList<beanMessages> arrImportantMessagesList;
	//ProgressDialog progresDialog;
	ProgressBar progressBar1;
	SharedPreferences prefUpdate;
	String UserId="",matri_id="",gender="";

	public FragmentMessagesImportant() {
	}

	public static FragmentMessagesImportant newInstance(int sectionNumber)
	{
		FragmentMessagesImportant fragment = new FragmentMessagesImportant();
	...
	{
		rootView=inflater.inflate(R.layout.fragment_messages_important, container,false);
	...
	private void getMessagesRequest(String MatriId)
	{
		...
		class SendPostReqAsyncTask extends AsyncTask<String, Void, String>
		{
			...
			protected String doInBackground(String... params)
			{
				...
				String URL= AppConstants.MAIN_URL +"important.php";
				Log.e("URL_Important", "== "+URL);
			...
			protected void onPostExecute(String result)
			{
				...
				Log.e("Important_Listing", "=="+result);
				...
				try
				{
					...
					{
						arrImportantMessagesList= new ArrayList<beanMessages>();
						...
						if (responseData.has("1"))
						{
							...
							while (resIter.hasNext())
							{
								...
								String is_favorite = resItem.getString("is_favourite");
								//String is_favorite="no";is_favourite

								arrImportantMessagesList.add(new beanMessages(mes_id,username,msg_important_status,from_matri_id,to_matri_id,
										subject,message,sent_date,msg_status,status1,user_photo,is_favorite));

							}

							if(arrImportantMessagesList.size() > 0)
							{
								recyclerUser.setVisibility(View.VISIBLE);
								textEmptyView.setVisibility(View.GONE);

								adapterMessages= new ImportantMessageAdapter(activity,arrImportantMessagesList, recyclerUser);
