...
import com.thegreentech.ViewImageActivity;
 ...
 */
public class Fragment_Ivisited extends Fragment {
    ...
    public Fragment_Ivisited() {

    }



    public static Fragment_Ivisited newInstance(int sectionNumber)
    {
        Fragment_Ivisited fragment = new Fragment_Ivisited();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vv =  inflater.inflate(R.layout.fragment_fragment__ivisited, container, false);
        //
