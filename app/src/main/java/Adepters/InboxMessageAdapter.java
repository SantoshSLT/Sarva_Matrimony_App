...
public class InboxMessageAdapter extends RecyclerView.Adapter
{
	...
	String matri_id="";
	String toID="";
	public InboxMessageAdapter(Activity activity, List<beanMessages> Users, RecyclerView recyclerView)
	{
	...
	public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position)
	{
		...
		{
			final beanMessages singleUser= (beanMessages) arrInboxMessagesList.get(position);
			...
			((UserViewHolder) holder).btnSendMessage.setOnClickListener(new OnClickListener()
			{
				...
				public void onClick(View v)
				{
					toID = singleUser.getFrom_matri_id();
			...
			protected void onPostExecute(String result)
			{
				...
				try
				{
					...
					if (status.equalsIgnoreCase("1"))
					{
						...
						if(isFavorite.equalsIgnoreCase("1"))
						{
							arrInboxMessagesList.get(pos).setMsg_important_status("0");
						}else
						{
							arrInboxMessagesList.get(pos).setMsg_important_status("1");
						}
