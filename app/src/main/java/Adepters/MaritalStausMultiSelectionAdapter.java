...
public class MaritalStausMultiSelectionAdapter extends RecyclerView.Adapter<MaritalStausMultiSelectionAdapter.MyViewHolder> {
    ...
    public MaritalStausMultiSelectionAdapter(Context context, ArrayList<beanGenralModel> fields_list, RelativeLayout SlidingDrawer, LinearLayout  Slidingpage,
                                             ImageView btnMenuClose, EditText edtMaritalStatus, Button btnConfirm)
    {
        ...
        this.edtMaritalStatus=edtMaritalStatus;
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position)
    {
        ...
        btnConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                edtMaritalStatus.setText(AppConstants.GeneralName);
