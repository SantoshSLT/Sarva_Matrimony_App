...
public class AnnualIncomeMultiSelectionAdapter extends RecyclerView.Adapter<AnnualIncomeMultiSelectionAdapter.MyViewHolder> {
    ...
    public AnnualIncomeMultiSelectionAdapter(Context context, ArrayList<beanGenralModel> fields_list, RelativeLayout SlidingDrawer, LinearLayout  Slidingpage,
                                             ImageView btnMenuClose, EditText edtAnnualIncome, Button btnConfirm)
    {
        ...
        this.edtAnnualIncome=edtAnnualIncome;
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position)
    {
        ...
        btnConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                edtAnnualIncome.setText(AppConstants.GeneralName);
