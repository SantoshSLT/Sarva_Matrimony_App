...
public class ManglikMultiSelectionAdapter extends RecyclerView.Adapter<ManglikMultiSelectionAdapter.MyViewHolder> {
    ...
    public ManglikMultiSelectionAdapter(Context context, ArrayList<beanGenralModel> fields_list, RelativeLayout SlidingDrawer, LinearLayout  Slidingpage,
                                        ImageView btnMenuClose, EditText edtManglik, Button btnConfirm)
    {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position)
    {
        ...
        btnConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                edtManglik.setText(AppConstants.GeneralName);
