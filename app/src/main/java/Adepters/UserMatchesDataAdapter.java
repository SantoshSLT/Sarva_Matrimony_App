...
public class UserMatchesDataAdapter extends RecyclerView.Adapter<UserMatchesDataAdapter.UserViewHolder>
{
	...
	public UserMatchesDataAdapter(Context context, List<beanUserData> Users, RecyclerView recyclerView,ArrayList<String> tokans)
	{
	...
	@Override
	public UserMatchesDataAdapter.UserViewHolder onCreateViewHolder(ViewGroup parent,int viewType)
	{
		UserMatchesDataAdapter.UserViewHolder vh;
	...
	public void onBindViewHolder(@NonNull final UserViewHolder holder, final int position) {
		if (holder instanceof UserViewHolder)
		{
			...
			((UserMatchesDataAdapter.UserViewHolder) holder).cardView.setOnClickListener(new OnClickListener()
			{
				@Override
				public void onClick(View v)
				{
		...
		{
			((UserMatchesDataAdapter.ProgressViewHolder) holder).progressBar.setIndeterminate(true);
		}
	}
	...
	public static class ProgressViewHolder extends UserMatchesDataAdapter.UserViewHolder
	{
	...
	private void addToShortListRequest(String login_matri_id,String strMatriId, final String isShortlisted, final int pos)
	{
	...
	private void addToBlockRequest(String login_matri_id,String strMatriId,final String isBlocked, final int pos)
	{
		progresDialog= new ProgressDialog(context);
		progresDialog.setCancelable(false);
		progresDialog.setMessage(context.getResources().getString(R.string.Please_Wait));
