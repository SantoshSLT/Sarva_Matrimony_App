...
public class ImportantMessageAdapter extends RecyclerView.Adapter {
    ...
    public ImportantMessageAdapter(Activity activity, List<beanMessages> Users, RecyclerView recyclerView) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.importantmessage_list, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof UserViewHolder) {
            ...
            ((UserViewHolder) holder).tvUserCode.setText(singleUser.getFrom_matri_id());
...
*/
            ((UserViewHolder) holder).btnSendMessage.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    new AlertDialog.Builder(activity)
                            .setMessage("Would you like to remove this message from important?")
                            .setPositiveButton("Remove", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    //getDeleteRequest(singleUser.getMes_id(),position);
                                    getRemoveImportantMessageRequest(singleUser.getMes_id(), position);
                                }
                            })
...
//            llFavourite = v.findViewById(R.id.llFavourite);
            ...
            btnSendMessage.setText("REMOVE IMPORTANT");
    ...
    //Remove Important Message
    private void getRemoveImportantMessageRequest(String message_id, final int pos) {
        progresDialog = new ProgressDialog(activity);
        progresDialog.setCancelable(false);
        progresDialog.setMessage(activity.getResources().getString(R.string.Please_Wait));
        progresDialog.setIndeterminate(true);
        ...
        class SendPostReqAsyncTask extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
                ...
                String URL = AppConstants.MAIN_URL + "remove_favourite.php";
                Log.e("remove_important", "== " + URL);

                HttpPost httpPost = new HttpPost(URL);

                BasicNameValuePair MatriIdPair = new BasicNameValuePair("msg_id", paramsMatriId);
        ...
        SendPostReqAsyncTask sendPostReqAsyncTask = new SendPostReqAsyncTask();
        sendPostReqAsyncTask.execute(message_id, String.valueOf(pos));
    }
