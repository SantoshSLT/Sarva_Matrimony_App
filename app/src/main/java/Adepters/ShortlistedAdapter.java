...
public class ShortlistedAdapter extends RecyclerView.Adapter<ShortlistedAdapter.UserViewHolder>
{
	...
	public ShortlistedAdapter(Context context, List<beanUserData> Users, RecyclerView recyclerView,ArrayList<String> tokans)
	{
	...
	public static class ProgressViewHolder extends ShortlistedAdapter.UserViewHolder
	{
