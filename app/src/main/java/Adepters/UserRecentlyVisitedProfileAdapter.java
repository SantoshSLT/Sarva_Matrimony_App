...
public class UserRecentlyVisitedProfileAdapter extends RecyclerView.Adapter<UserRecentlyVisitedProfileAdapter.UserViewHolder> {
    ...
    public UserRecentlyVisitedProfileAdapter(Context context, List<beanUserData> Users, RecyclerView recyclerView,ArrayList<String> tokans)
    {
    ...
    @NonNull
    @Override
    public UserRecentlyVisitedProfileAdapter.UserViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        UserRecentlyVisitedProfileAdapter.UserViewHolder vh;
    ...
    public static class ProgressViewHolder extends  UserRecentlyVisitedProfileAdapter.UserViewHolder
    {
