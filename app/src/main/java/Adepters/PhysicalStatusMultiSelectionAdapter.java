...
public class PhysicalStatusMultiSelectionAdapter extends RecyclerView.Adapter<PhysicalStatusMultiSelectionAdapter.MyViewHolder> {
    ...
    public PhysicalStatusMultiSelectionAdapter(Context context, ArrayList<beanGenralModel> fields_list, RelativeLayout SlidingDrawer, LinearLayout  Slidingpage,
                                               ImageView btnMenuClose, EditText edtPhysicalStatus, Button btnConfirm)
    {
        ...
        this.edtPhysicalStatus=edtPhysicalStatus;
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position)
    {
        ...
        btnConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                edtPhysicalStatus.setText(AppConstants.GeneralName);
